...
(function ($, _, undefined) {
    ...
    var MentionsInput = function (settings) {
        ...
        function onInputBoxKeyPress(e) {
            console.log(e);
            if(e.keyCode !== KEY.BACKSPACE && e.keyCode !== KEY.ENTER) { //If the key pressed is not the backspace
        ...
        function onInputBoxKeyDown(e) {
            ...
            if(e.which === 13) {
                if($(this).parents('.commentForm').length > 0) {
                    if($(this).parents('.commentForm').find('.mentions-autocomplete-list:visible').length == 0) {
