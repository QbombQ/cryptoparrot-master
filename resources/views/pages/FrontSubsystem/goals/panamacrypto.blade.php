@extends('pages.FrontSubsystem.layout',[
    'title' => 'You\'ve been invited by Panama Crypto to participate in his very own Top Trader Competition on Niffler.co',
    'classes' => 'shards-landing-page--1 goal-landing',
    'landing' => true, 
    'description' => 'Compete with fellow crypto traders personally invited by Panama Crypto within a completely safe and FREE crypto trading environment! As a top performing trader topping the leaderboard you have an opportunity to win amazing prizes like a Nano Ledger S, $100 in the crypto of your choice and Niffler.co swag!',
    'nofollow'=>true,
    'poster' => 'assets/images/panama-crypto-poster.jpg?v=2',
    'html_class'=>''    
])  
    ...
    @section('content')
        ...
        <div class="welcome goal-landing-top">
            ...
            <!-- / Navigation -->
                     ...
                     <div class="dgb-row text-center p-4 mt-3">
                       
                          <img class="mb-5" style="max-width: 150px;border-radius: 50%;" src="{{ asset('assets/images/logos/panama-logo.jpg') }}" alt="Panama crypto logo">
            ...
            <div class="row px-3 px-sm-0 pt-lg-5 pb-5">
                <div class="col-lg-7 content-part">
                    ...
                    <h1 class="h3 welcome-heading mb-4 mt-5 mt-lg-0 text-white "><small style="display: block;line-height: 1.3;">You've been invited by Panama Crypto to participate in his very own Top Trader Competition on Niffler.co</small>
                    </h1> 
 
                    <p class="text-white  mb-3">Compete with fellow crypto traders personally invited by Panama Crypto within a completely safe and FREE crypto trading environment! As a top performing trader topping the leaderboard you have an opportunity to win amazing prizes like a Nano Ledger X, $100 in the crypto of your choice and Niffler.co swag!</p>   

                    <p class="text-white  mb-3">Our Top Trader Competitions for crypto influencers and their followers are a fun and unique way for them to reward their followers and hep them learn even more about crypto through education based crypto trading competitions.</p> 

                    <p class="text-white  mb-3">In order to take part, follow <a class="font-weight-bold" target="_blank" href="https://twitter.com/Panama_TJ?lang=en">@Panama_TJ</a>, register here and don't forget to help spread the word amongst others in the crypto community! Once we hit the designated number of participants below, we'll open up the PanamaCrypto Top Trader Competition and notify you!</p>  

                    <div class="progress mb-5" style="height: 30px;">
                      <span class="progress-label">{{ $totalRegisteredWithCode }} out of 250</span>
