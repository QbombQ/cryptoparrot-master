@extends('pages.FrontSubsystem.layout',[
    'title' => 'Show your support for STEEM getting listed on Niffler.co',
    'classes' => 'shards-landing-page--1 goal-landing',
    'landing' => true, 
    'description' => 'Want to see STEEM on the Niffler.co exchange? Show your support by pre-registering and if enough STEEM fans and supporters do, we’ll add STEEM to the Niffler.co simulated exchange!',
    'nofollow'=>true,
        ...
        <div class="welcome goal-landing-top">
            ...
            <!-- / Navigation -->
                     ...
                     <div class="dgb-row text-center p-4 mt-3">
                          ...
                          <img class="mb-4" style="max-width: 250px;" src="/assets/images/logos/steem.png" alt="Steem logo">
            ...
            <div class="row px-3 px-sm-0 pt-lg-5 pb-5">
                <div class="col-lg-7">
                    ...
                    <h1 class="h3 welcome-heading mb-4 mt-5 mt-lg-0 text-white ">Show your support for <br class="d-none d-lg-block"/><strong>STEEM</strong> getting listed on Niffler.co
                    </h1> 

                    

                    <p class="text-white  lead mb-3">Niffler.co is a real time simulated crypto exchange that allows newbies the ability to learn about crypto trading without the risk,…once they get good enough, they can make money by teaching others!</p>   

                    <p class="text-white   lead mb-3">Want to see Steem on the Niffler.co exchange? Show your support by registering and if enough STEEM fans and supporters do, we’ll add STEEM to the Niffler.co exchange!</p>

                    <p class="text-white  lead mb-3">So do your part and play a role in helping introduce the world to Steem and Steemit!</p> 
