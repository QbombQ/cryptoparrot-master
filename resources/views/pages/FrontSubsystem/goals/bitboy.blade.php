@extends('pages.FrontSubsystem.layout',[
    'title' => 'You\'ve been invited by BitBoy to participate in his very own Top Trader Competition on Niffler',
    ...
    'nofollow'=>false,
    'poster' => 'assets/images/bitboy-poster.jpg',
    'html_class'=>''    
]) 
        ...
        <div class="welcome goal-landing-top">
            ...
            <!-- / Navigation -->
                     ...
                     <div class="dgb-row text-center p-4 mt-3">
                          ...
                          <img class="mb-4" style="max-width: 300px;" src="{{ asset('assets/images/logos/bitboy-crypto-white.png') }}" alt=""> 
            ...
            <div class="row px-3 px-sm-0 pt-lg-5 pb-5">
                <div class="col-lg-7 content-part">
                    ...
                    <h1 class="h3 welcome-heading mb-4 mt-5 mt-lg-0 text-white "><small style="display: block;line-height: 1.3;">Congrats! You've been invited by BitBoy to participate in his very own Top Trader Competition on Niffler</small>
                    </h1> 
 
                    <p class="text-white  mb-3">Compete with fellow crypto traders personally invited by BitBoy within a completely safe and FREE crypto trading environment! As a top performing trader topping the leaderboard you have an opportunity to win amazing prizes like a Nano Ledger S, $100 in the crypto of your choice and Niffler swag!</p>   

                    <p class="text-white  mb-3">Our Top Trader Competitions for crypto influencers and their followers are a fun and unique way for them to reward their amazing followers by helping them learn even more about crypto through education based crypto trading competitions.</p> 

                    <p class="text-white  mb-3">In order to take part, follow <a class="font-weight-bold" target="_blank" href="https://twitter.com/Bitboy_Hodl">@Bitboy_Hodl</a>, register here or on the <a class="font-weight-bold" target="_blank" href="https://niffler.co">Niffler.co</a> site and don't forget to help spread the word amongst others in the crypto community! Once we hit the designated number of participants below, we'll open up the BitBoy Top Trader Competition!</p>  

                    <div class="progress mb-5" style="height: 30px;">
                      <span class="progress-label">{{ $totalRegisteredWithCode }} out of 150</span>
