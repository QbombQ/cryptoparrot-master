@extends('pages.FrontSubsystem.layout',[
    'title' => 'Congrats! You\'ve been invited by the Crypto Curator to participate in his very own Top Trader Bracket Competition on Niffler.co',
    'description' => 'Compete with fellow crypto traders personally invited by the Crypto Curator within a completely safe and FREE simulated crypto trading environment!',
    'classes' => 'shards-landing-page--1 goal-landing',
    'landing' => true, 
    'nofollow'=>true,
    'poster' => 'assets/images/cryptocurator-og.jpg',
    'html_class'=>''   
])  
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-5">
                                   <h5 class="mb-4 font-weight-bold">Prizes / Sponsors</h5>
                                    
                                    <p>Begin (Aug 15th) 64 Players</p>

                                    <p><span class="font-weight-bold">Round 1 (Aug 21st) 32 players</span> - <a target="_blank" href="https://hodlfuel.com" class="font-weight-bold">HODLfuel</a> (Top 3 players) Coffee</p>

                                    <p><span class="font-weight-bold">Round 2 (Aug 28th) 16 players</span> - <a target="_blank" href="https://coldstoragecoins.com" class="font-weight-bold">Cold Storage Coins</a> (Top 3 Players)</p>
                                    
                                    <p><span class="font-weight-bold">Round 3 (Sep 4th) 8 players</span> - <a target="_blank" href="http://shorthebanks.com" class="font-weight-bold">Short The Banks</a> (Top 3 Players) T-Shirts/Mugs</p>

                                    <p><span class="font-weight-bold">Round 4 (Sep 11th) 4 players</span> - <a target="_blank" href="https://www.delphidigital.io" class="font-weight-bold">DelphiDigital</a> (Top 3 Players) Crypto Reports</p>

                                    <p><span class="font-weight-bold">Semis (Sep 18th) 2 players</span> - <a target="_blank" href="https://itrustcapital.com" class="font-weight-bold">iTrustCapital</a> (Top 2 Players) opening IRA/401K accounts</p>

                                    <p><span class="font-weight-bold">Finals (Sep 25th)</span> - <a target="_blank" class="font-weight-bold" href="https://www.ellipal.com">Ellipal Hardware Wallet</a> - Top Level (Overall Winner) Winner</p>
        ...
        <div class="welcome goal-landing-top">
            ...
            <!-- / Navigation -->
                     ...
                     <div class="dgb-row text-center pb-4 mt-3"> 
                        ...
                        <img class="mb-4 mt-4" style="max-width: 200px;" src="{{ asset('assets/images/logos/CryptoCuratorLogo.png') }}" alt=""> 
            ...
            <div class="row px-3 px-sm-0 pt-lg-5 pb-5">
                <div class="col-lg-7 content-part">
                    
                    <div class="pr-lg-3">

                    <h1 class="h3 welcome-heading mb-4 mt-5 mt-lg-0 text-white "><small style="display: block;line-height: 1.3;">Congrats! You've been invited by the Crypto Curator to participate in his very own Top Trader Bracket Competition on Niffler.co</small>
                    </h1> 
 
                    <p class="text-white  mb-3">Compete with fellow crypto traders personally invited by the Crypto Curator within a completely safe and FREE simulated crypto trading environment! As a top performing trader topping the leaderboard at the end of the competition, you have an opportunity to win amazing prizes like an Ellipal Hardware Wallet, access to valuable crypto services from iTrust Capital & Delphi Digital, swag from Short the Banks, HodlFuel coffee and so much more.</p>   

                    <p class="text-white  mb-3">Our Top Trader Competitions for crypto influencers and their friends are a fun and unique way for them to network and learn even more about crypto through risk free simulated crypto trading competitions.</p> 

                    <p class="text-white  mb-3">In order to take part in the Crypto Curator competition register via the form on the right. Once we hit the designated number of participants below, we'll open up the Crypto Curator Top Trader Bracket Competition!</p>   


                      <a data-toggle="modal" data-target="#prizes" href="" class="mb-3 text-warning d-block">View Prizes <i class="fal fa-arrow-right"></i></a> 

                    <div class="progress mb-5" style="height: 30px;">
                      <span class="progress-label">{{ $totalRegisteredWithCode }} out of 64</span>
