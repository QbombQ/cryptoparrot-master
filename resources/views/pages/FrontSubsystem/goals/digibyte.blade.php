@extends('pages.FrontSubsystem.layout',[
    'title' => 'Show your support for DigiByte getting listed on Niffler.co',
    'classes' => 'shards-landing-page--1 goal-landing',
    'landing' => true, 
    'description' => 'You\'ve been invited by DigiByte & the DGB Awareness Team to participate in your very own DigiByte community Top Trader Competition!',
    'nofollow'=>true,
        ...
        <div class="welcome goal-landing-top">
            ...
            <!-- / Navigation -->
                     ...
                     <div class="dgb-row text-center p-4 mt-3">
                          ...
                          <img class="mb-4" style="max-width: 250px;" src="https://github.com/digibyte/digibyte-logos/blob/master/Logos%20Bitmap/transparent%20bg/ClearDarkBlueBg%20DigiByte%20Bc%201.png?raw=true" alt="DigiByte logo">
            ...
            <div class="row px-3 px-sm-0 pt-lg-5 pb-5">
                <div class="col-lg-7">
                    ...
                    <h1 class="h3 welcome-heading mb-4 mt-5 mt-lg-0 text-white "><small style="display: block;line-height: 1.3;">You've been invited by DigiByte & the DGB Awareness Team to participate in your very own DigiByte community Top Trader Competition!</small>
                    </h1> 

                    <p class="text-white  mb-3 lead">Compete with fellow DigiByte community members within a completely safe, fun and FREE simulated crypto trading environment! As a top performing trader topping the leaderboard you have an opportunity to win amazing prizes like a Nano Ledger S, $100 in DGB, $50 in the crypto of your choice and many other exciting prizes!</p>   

                    <p class="text-white  mb-3 lead">The DigiByte Top Trader Competition is much more than just a unique way for DigiByte's community to learn more about blockchain &amp; cryptocurrencies through an education based simulated crypto trading competition, it's also a great way for the DigiByte community to connect w/ each other! Be sure to register today as the competition starts Dec 1st 2018 and get ready to have some fun!</p> 
