...
return [
    ...
    */
    ...
    'discord' => [
        ...
        'redirect' => env('APP_URL').'/callback/discord'
    ],
    ...
    'reddit' => [
        'client_id' => env('REDDIT_CLIENT_ID'),         // Your GitHub Client ID
        'client_secret' => env('REDDIT_CLIENT_SECRET'), // Your GitHub Client Secret
        'redirect' => env('APP_URL').'/callback/reddit',
    ],     
